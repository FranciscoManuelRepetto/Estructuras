...
public class AVL {
    ...
    private boolean insertarAux(NodoAVL n,Comparable elem,NodoAVL padre){
        ...
        /*Actualiza la altura de cada nodo a la vuelta y balancea el arbol*/
            ...
            aux=balancear(n);
            if(aux!=null)
                /*Si hubo rotaciones, enlaza el nuevo subArbol*/
                reenlace(aux,padre);
        return exito;
    }
    ...
    private NodoAVL rotarIzquierda(NodoAVL r){
        NodoAVL h=r.getDerecho(),temp=null;
    ...
    private NodoAVL rotarDerecha(NodoAVL r){
        NodoAVL h=r.getIzquierdo(),temp=null;
    ...
    private NodoAVL caso3(NodoAVL nodo,NodoAVL padre,NodoAVL elim){
    ...
    private void eliminarMaximoAux(NodoAVL nodo,NodoAVL padre){
        /*Recorro el arbol hasta el ultimo hijo derecho*/
        if(nodo.getDerecho()!=null){
            eliminarMaximoAux(nodo.getDerecho(),nodo);
            /*Actualizo la altura del nodo y balancea el arbol*/
            nodo.recalcularAltura();
            NodoAVL aux;
            aux = balancear(nodo);
