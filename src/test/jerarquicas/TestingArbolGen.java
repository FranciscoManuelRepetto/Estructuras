...
public class TestingArbolGen {
   ...
   public static final String RESET = "\u001B[0m";
	...
	System.out.println("Altura de arbol clon:  "+b.altura());
        ...
        System.out.println("\n");
        System.out.println("Recorrido en Niveles.\n Tiene que dar:[10 - 9 - 15 - 7 - 3 - 12 - 20 - 22 -30 -10 -40 - 45 - 55]  "+a.listarPorniveles().toString());
        ...
        System.out.println("\nPruebo el metodo frontera");
        System.out.println("Deberia devolver [7, 10, 12, 20, 22, 40, 45, 55] \t\t"+a.frontera().toString());
        a.vaciar();
        System.out.println("Pruebo cuando el arbol esta vacio");
        System.out.println("Deberia devolver null \t\t\t\t\t\t"+a.frontera().toString());
        System.out.println("Pruebo si la hoja es la raiz ");
        a.insertar(7, null);
        System.out.println("Deberia devolver [7] \t\t\t\t\t\t"+a.frontera().toString());
        System.out.println("Pruebo si la raiz tiene un hijo izquierdo");
        System.out.println("Agrego como hijo izquierdo 10 \t\t\t\t\t"+a.insertar(10,7));
        System.out.println("Deberia devolver [10] \t\t\t\t\t\t"+a.frontera().toString());
        System.out.println("Agrego como hermano derecho 12 \t\t\t\t\t"+a.insertar(12,7));
        System.out.println("Pruebo si la raiz tiene un hijo izquierdo y un hijo derecho");
         System.out.println("Deberia devolver [10,12]   \t\t\t\t\t"+a.frontera().toString());
    }
