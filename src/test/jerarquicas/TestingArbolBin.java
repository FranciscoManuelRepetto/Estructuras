...
public class TestingArbolBin {
   ...
   public static final String RESET = "\u001B[0m";
	...
	System.out.println("Altura de arbol clon:  "+b.altura());
        ...
        System.out.println("Pruebo con el hijo izquierdo de la raiz: ");
        System.out.println("Ancestros de 9 \t\t\t\t\t Espera: [10] \t\t\t"+a.obtenerAncestros(9).toString());
        System.out.println("Pruebo con hijo de mas nivel ");
        System.out.println("Ancestros de 3 \t\t\t\t\t Espera: [10, 9] \t\t"+a.obtenerAncestros(3).toString());
        System.out.println("Pruebo con hijo derecho");
        System.out.println("Ancestros de 15 \t\t\t\t Espera: [10] \t\t\t"+a.obtenerAncestros(15).toString());
        System.out.println("Pruebo con hijo derecho de mas nivel");
        System.out.println("Ancestros de 12 \t\t\t\t Espera: [10, 15] \t\t"+a.obtenerAncestros(20).toString());
        System.out.println("Pruebo con hermanos");
        System.out.println("Ancestros de 12 y 20 \t\t\t         Espera: [10, 15] ambos casos   12: "
                +a.obtenerAncestros(12).toString()+" 20: "+a.obtenerAncestros(20).toString());
        System.out.println("Pruebo con la raiz");
        System.out.println("Ancestros de 10 \t\t\t\t Espera: null \t\t\t"+a.obtenerAncestros(10).toString());
        System.out.println("Pruebo con numero que no esta en el arbol");
        System.out.println("Ancestros de 35 \t\t\t\t Espera: null \t\t\t"+a.obtenerAncestros(35).toString());
        System.out.println("Ancestro de 3 en arbol vacio \t\t\t Espera: null \t\t\t"+b.obtenerAncestros(3));
